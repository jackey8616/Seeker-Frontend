<template>
  <div class="privacy-policy">
    <div class="container mx-auto px-4 py-8 max-w-4xl">
      <h1 class="text-3xl font-bold mb-8">Seeker Privacy Policy</h1>
      ...
      <div class="prose prose-lg">
        ...
        <section class="mb-8">
          ...
          <p>
            Welcome to Seeker(seeker.clo5de.info). We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.
          </p>
        </section>
        ...
        <section class="mb-8">
          ...
          <p>
            The data controller responsible for your personal data is the developer operating this website. For the data controller information, please refer to the "Contact Us" section at the end of this policy.
          </p>
        </section>
        ...
        <section class="mb-8">
          ...
          <ul class="list-disc pl-6 space-y-2">
            ...
            <li><strong>Data From Social Networks:</strong> User information from social networking sites, including your name, your social network username, email address and profile picture, if you connect your account to such social networks.</li>
          </ul>
        </section>

        <section class="mb-8">
          <h2 class="text-2xl font-semibold mb-4">Use of Your Information</h2>
          <p>Having accurate information about you permits us to provide you with a smooth, efficient, and customized experience. Specifically, we may use information collected about you via the Site to:</p>
          <ul class="list-disc pl-6 space-y-2">
            <li>Create and manage your account.</li>
            <li>Send you administrative information, such as information about changes to our terms, conditions, and policies.</li>
            <li>Improve our services and operations.</li>
            <li>Understand and analyze how you use our Site and services, which can improve our overall functionality.</li>
        ...
        <section class="mb-8">
          <h2 class="text-2xl font-semibold mb-4">Policy for Children</h2>
          <p>
        ...
        <section class="mb-8">
          ...
          <ul class="list-disc pl-6 space-y-2">
            ...
            <li><strong>Right to Rectification:</strong> You have the right to request correction of inaccurate personal data we have about you.</li>
